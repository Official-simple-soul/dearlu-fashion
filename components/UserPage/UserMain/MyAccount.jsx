    ...
    <div className="text-[#2F2F2F] text-center md:text-left">
      {
        ...
        <div className="contact bg-[#F5F5F5] p-5 w-full">
          ...
          <div className="left space-y-4">
            <h1>
              Name: <br className='md:hidden'></br><span className="ml-3 font-bold">{user?.user?.name}</span>
            </h1>
            <h1>
              Email address:{' '}
        ...
        <div className="delivery bg-[#F5F5F5] p-5">
          ...
          <div className="flex-col md:flex justify-between my-3">
            <p>{allCurrent.phoneAdd? allCurrent.phoneAdd: 'No phone number yet'}</p>
            <p>{ allCurrent.countryAdd? allCurrent.cityAdd + ', ' + allCurrent.stateAdd  + ', ' + allCurrent.countryAdd : 'No Address yet'}</p>
            <button className="mt-2 mx-auto flex items-center border border-primary-400 text-sm px-2 py-1 rounded-md" onClick={()=>setNewAddress
              (true)}>
          ...
          <button className='border border-primary-400 px-2 rounded-md mt-3 hover:bg-grey-100 hover:text-primary-400' onClick={handleNewAddress}>Save Address</button>
            </div>
          }
          
          <button className={`${allCurrent.countryAdd && 'hidden'} mt-5 text-[#F5F5F5] text-sm rounded-md bg-primary-400 px-8 py-2`} onClick={()=>setNewAddress(!newAddress)}>
