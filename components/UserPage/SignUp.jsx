...
console.log(password.length>8)
  return (
    <div className="flex justify-center items-center py-14 ">
      <form action="" onSubmit={handleFormSubmit} className="shadow-xl shadow-primary-400 bg-white py-3 px-3 md:px-8 text-black rounded-md">
        ...
        <div className="password relative">
          ...
          <p className='text-[10px] text-secondary-100'>Password must contain atleast 8 characters</p>
        </div>
        <button type='submit' className='w-full bg-primary-400 h-8 rounded-md text-white mt-8'>Create an account</button>
      </form>
    </div>
  );
}
